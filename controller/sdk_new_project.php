...
class sdk_new_project extends fs_controller
{
    ...
    protected function private_core()
    {
        ...
        if(isset($_POST['save']))
        {
            $model = $this->get_model_info($_POST['model']);
            if(empty($_POST['model']) || $model['items'])
            {
            ...
            {
                $this->new_error_msg("No se encuentra el modelo {$_POST['model']}");
            }
        }
    }
